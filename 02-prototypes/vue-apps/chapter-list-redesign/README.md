...
```bash
cd Product-SDD-Workbench/projects/chapter-list-redesign/02-prototypes/vue-apps/chapter-list-redesign
...
| 文档 | 路径 |
|------|------|
| PRD V1.x | `../../01-prd/章节列表页迭代_V1.2.md` |
| 功能点清单 | `../../01-prd/v5-feature-list.md` |
| SDD 技术规格 | `../../04-specs/sdd/chapter-list.sdd.json` |
| 功能详细设计 | `../../04-specs/feature-specs/*.md` |
